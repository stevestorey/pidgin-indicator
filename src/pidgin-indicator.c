...
init_plugin(PurplePlugin *plugin) {
  info.name = _("Status icon using libappindicator");
  info.summary = _("Status icon for use in libappindicator envirionments");
  info.description = _("Show a Status icon in modern desktops");
}
